...
Welcome_window.kt - original code for the camera screen
new welcome_window.kt is the cleaned up version with some things changed up and unnecessary bloat deleted
